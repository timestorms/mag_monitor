<?php 
class PageAjax extends Think
{
    protected $firstRow	; //分页起始行数 * @var integer * @access protected
    protected $listRows	; //列表每页显示行数 * @var integer * @access protected
    protected $parameter  ; //页数跳转时要带的参数 * @var integer * @access protected
    protected $totalPages  ; //分页总页面数 * @var integer * @access protected
    protected $totalRows  ; //总行数 * @var integer * @access protected
    protected $nowPage    ; //当前页数 * @var integer * @access protected
    protected $coolPages   ; //分页的栏的总页数 * @var integer * @access protected
	...
	// 分页显示定制
    protected $config   =	array('prev'=>'&lsaquo;','next'=>'&rsaquo;','first'=>'First','last'=>'Last');
    protected $ajaxFunc =""   ; //ajax分页函数 * @var integer * @access protected
